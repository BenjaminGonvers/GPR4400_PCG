...
public class ProceduralGeneratorRoom : MonoBehaviour
{
    ...
    [Tooltip("Max size of a room, this define the maximum size possible room")]
    [SerializeField] private Vector2Int _maxSizeRoom;
    [Tooltip("Min size of a room, this define the minimal size possible room")]
    [SerializeField] private Vector2Int _minSizeRoom;
